...
For problem2\_data\_dumpster, the number of observations is 285. The key
...
For problem2\_data\_rbind, the number of observations is 24. The three
...
represented which means every state is represented. The state “NJ” is
observed the most.
